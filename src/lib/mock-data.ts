...
export const demoTrades: TradeWithAnalysis[] = [
  {
    ...
    commission: null,
    swap: null,
    account_balance_at_sync: null,
    account_equity_at_sync: null,
    account_currency: null,
    symbol_tick_value: null,
    symbol_tick_size: null,
    symbol_contract_size: null,
    symbol_point: null,
    symbol_digits: null,
    estimated_risk_amount: null,
    estimated_risk_percent: null,
    risk_calculation_method: null,
    screenshot_url: null,
    checklist_results: [],
    passed_rules: [],
    failed_rules: [],
